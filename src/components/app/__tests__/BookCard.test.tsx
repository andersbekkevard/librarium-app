...
describe('BookCard', () => {
  ...
  describe('Reading States', () => {
    it('should display correct badge for not_started state', () => {
      ...
      expect(badge).toHaveClass('bg-slate-50', 'text-slate-500', 'border-slate-200')
    })
    ...
    it('should display correct badge for finished state', () => {
      ...
      expect(badge).toBeInTheDocument()
      expect(badge).toHaveClass('bg-slate-800/10', 'text-slate-800', 'border-slate-800/20')
    })
  })
  ...
  describe('Progress Display', () => {
    it('should show progress bar for in_progress books', () => {
      ...
      const progressBar = screen.getByRole('button').querySelector('[style*="width: 50%"]')
  ...
  describe('Rating Display', () => {
    it('should show star rating for finished books with rating', () => {
      ...
      const stars = screen.getAllByRole('button').filter(el => 
        el.querySelector('svg') && el.querySelector('svg')?.classList.contains('fill-yellow-400')
      )
  ...
  describe('Text Truncation', () => {
    ...
    it('should handle long author names appropriately', () => {
      const bookWithLongAuthor: Book = {
        ...mockBook,
        author: 'This is a very long author name that should be truncated when displayed',
      }
